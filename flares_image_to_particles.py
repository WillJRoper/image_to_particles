...
vel_mag = 2
vels[np.logical_and(top, left), 0] = vel_mag
vels[np.logical_and(top, centre), 0] = 0
vels[np.logical_and(top, right), 0] = -vel_mag
vels[np.logical_and(middle, left), 0] = vel_mag
vels[np.logical_and(middle, centre), 0] = 0
vels[np.logical_and(middle, right), 0] = -vel_mag
vels[np.logical_and(bottom, left), 0] = vel_mag
vels[np.logical_and(bottom, centre), 0] = vel_mag
vels[np.logical_and(bottom, right), 0] = -vel_mag
vels[np.logical_and(top, left), 1] = 0
vels[np.logical_and(top, centre), 1] = -vel_mag
vels[np.logical_and(top, right), 1] = 0
vels[np.logical_and(middle, left), 1] = vel_mag
vels[np.logical_and(middle, centre), 1] = 0
vels[np.logical_and(middle, right), 1] = -vel_mag
vels[np.logical_and(bottom, left), 1] = 0
vels[np.logical_and(bottom, centre), 1] = vel_mag
